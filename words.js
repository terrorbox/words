 ...
 *
 * [NB: words.js is built using build.sh. Expect changes here to be overwritten]
 */

javascript:(function () {

    // list of words to avoid based on internal rules and the Yahoo! Style Guide
    var words = [
            ...
            ['additional',"Too complex. Try to simplify.. Try 'extra' or 'more'."],
            ...
            ['agenda',"Don't use unless referring to something for a meeting."],
            ...
            ['impacted',"Don't use it as a verb."],
            ['implement', "jargon"],
            ...
            ['key',"Unless it unlocks something. A subject/thing isn't 'key.' It's probably 'important' though."],
            ['leverage',"jargon"],
            ['leveraging',"jargon"],
            ['liaise',"jargon"],
            ['liaising',"jargon"],
            ...
            ['sustainable',"jargon"],
            ['tackle',"Avoid. Unless it's rugby, football, some other sport."],
            ['tackled',"Avoid. Unless it's rugby, football, some other sport."],
            ['tackling',"Avoid. Unless it's rugby, football, some other sport."],
            ...
            ['wrinkl',"adverb"],
            ['yearl',"adverb"],
            ['have the ability to',"Use 'you're able to' or start with verb."],
            ...
            ['terms of use',"Make sure to use 'Terms of Use' when referring to our own. Lowercase if referring to a third-party's."]
	],
